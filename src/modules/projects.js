...
export async function initProjects() {
    ...
    try {
        ...
        projectList.forEach((project, iterationIndex) => {
            ...
            // 💡 Generate a dynamic link using the project's unique ID or index
            const projectId = project.id || iterationIndex;
            const projectLink = `project-info.html?id=${projectId}`;


            projectsHTML += `
    <a href="${projectLink}" target="_blank" rel="noopener noreferrer" class="project-card">
